	        ...
	        <div class="row main_div" id="zhidingtitle">
	          <c:forEach items="${list}" var="news">
		         <div class="clear col-md-3 new-div">
			            ...
			            <span>日期:</span><span class="col-888 news-time">${news.release_time}</span>
			            <span  style="margin-left: 40px;">阅读量:</span><span class="col-888 news-quantity">${news.read_quantity}</span>
			            </p>
			            </div>
		            </div>
	            </c:forEach>
