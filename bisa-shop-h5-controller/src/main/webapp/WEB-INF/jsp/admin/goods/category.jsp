                ...
                <div class="layui-form-item mb-0" pane="">
                    <div class="layui-input-block">
                        <div class="layui-inline">
                        	<button type="button" id="addPage" class="layui-btn"><spring:message code='2004' /></button>
                        </div>
                    </div>
                </div>
        </div>
        	...
        	<div class="site-text site-block">
	            <form class="layui-form"  id="serverForm" lay-filter="form"  method="post">
	                ...
	                <div class="layui-form-item ">
	                    <label class="layui-form-label" style="width: 110px;padding-left:0px;"><spring:message code='2005' /></label>
	                    <div class="layui-input-inline">
	                        <input type="text" name="name"  lay-verify="required" placeholder="<spring:message code='2019' />"  class="layui-input">
	                    </div>
	                ...
	                <div class="layui-form-item">
	                    <label class="layui-form-label " style="width: 110px;padding-left:0px;"><spring:message code='2006' /></label>
	                    <div class="layui-input-inline">
	                         <select id="super_id" name="super_id" lay-verify="required">
	   							 	<option value="0"><spring:message code='empty' /></option>
	                         </select>
...
<script type="text/javascript">
    ...
    layui.use(['element', 'table', 'upload','form','laypage'], function () {
         ...
         $=layui.jquery;
       	...
       	form.on('submit(create)', function(data){
       		$.ajax({
				...
				url : '/admin/goods/ajax/category/add',
				data : data.field,
        ...
        var tableIns =table.render({
            ...
            url: '/admin/goods/ajax/category/list',
            method:'GET',
            totalRow:true,
            ...
            cols: [
                [ //标题栏
                    ...
                    {field: 'name', title: '<spring:message code="2005" />', width: '30%', align: 'center'},
                    ...
                    {field: 'c_time', title:"<spring:message code='time' />", width: '20%', align: 'center'},
        	...
        	$.ajax({
				...
				success: function(obj) {
					...
					if(obj.code=="${SysStatusCode.SUCCESS}"){
						if(obj.count>0){
							$("#super_id").append("<option value='0'>"+'<spring:message code='select' />'+"</option>");
							for(var i = 0; i < obj.data.length; i++) {
								//添加option元素
								$("#super_id").append("<option value='" + obj.data[i].id + "'>" + obj.data[i].name + "</option>");
							}
						}
		        	...
		        	$.ajax({
						url: "/admin/goods/ajax/category/load",
						type: "GET",
						data:where,
						success: function(data) {
							if(data.code=="${SysStatusCode.SUCCESS}"){
