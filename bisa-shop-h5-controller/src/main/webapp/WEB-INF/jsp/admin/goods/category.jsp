                ...
                <div class="layui-form-item mb-0" pane="">
                    <div class="layui-input-block">
                        <div class="layui-inline">
                        	<button type="button" id="addPage" class="layui-btn">新增商品分类</button>
                        </div>
                    </div>
                </div>
        </div>
        	...
        	<div class="site-text site-block">
	            <form class="layui-form"  id="serverForm" lay-filter="form"  method="post">
	                ...
	                <div class="layui-form-item ">
	                    <label class="layui-form-label" style="width: 110px;padding-left:0px;">商品分类名</label>
	                ...
	                <div class="layui-form-item">
	                    <label class="layui-form-label " style="width: 110px;padding-left:0px;">商品分类父ID</label>
	                    <div class="layui-input-inline">
        ...
        var tableIns =table.render({
            ...
            cols: [
                [ //标题栏
                    ...
                    {field: 'name', title: '商品分类名字', width: '15%', align: 'center'},
