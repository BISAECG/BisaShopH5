    ...
    <div class="content">
        <div class="container-full">
            <div class="row" style="margin: 0;">
                <img class="img-responsive center-block" src="/resources/img/index/offer.png" alt="碧沙康健心電儀限時活動">
            </div>
            <div class="row" style="margin: 0;">
                <div class="col-xs-12">
                    <p class="title-p text-center">所有產品</p>
                    <div class="line">
                        <p class="line-top"></p>
                        <p class="line-btm"></p>
                    </div>
                ...
                <div class="col-xs-6 col-sm-6 mb-20 product">
                    ...
                    <div class="row">
                        <div class=" col-xs-10 col-xs-offset-1" style="padding: 0;">
                            ...
                            <p class="product_Introduction">世界首創三導聯無線攜帶式心電記錄儀aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa </p>
                            <div class="product_price mt-15">
                                <span>￥1280</span>
                                <span>￥1800</span>
                                <a class="pull-right" href="details.html">查看詳情</a>
                            </div>
                        </div>
                    </div>
                </div>
