        ...
        <div class="col-xs-12">
            <ul>
            	 <#list empList as item>
           				<li><a href='${item.name}.html'>${item.column_name_US} <i class="fa fa-chevron-right pull-right" ></i></a></li> 
						 <#if (item_index == 0)>
						 	<li> <a href="news.html">News<i class="fa fa-chevron-right pull-right" ></i> </a></li>   
		                    <li> <a href="qa.html">Health Q & A <i class="fa fa-chevron-right pull-right"></i> </a></li>   
						 </#if>
				 </#list>
