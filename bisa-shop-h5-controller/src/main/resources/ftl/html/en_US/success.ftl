    ...
    <div class="container-full">
        ...
        <div class="row" style="margin: 0.25rem 0;">
            <div class="col-xs-12 text-center service ">
                <p>We will arrange delivery as soon as possible</p>
                <p><span> If you have any questions, please contact</span><span>(852) 2423 0600</span></p>
            </div>
        </div>
        <div class="row">
            <div class="col-xs-12 success">
                <a href="shop.html">View all products</a>
                <a href="details.html">Continue to buy</a>
            </div>
        </div>
    </div>
</body>
