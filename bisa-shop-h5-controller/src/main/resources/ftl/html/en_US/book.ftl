		...
		<form class="layui-form" id="messageForm" action="">
			...
			<div class="form-group messageFour">
				...
				<textarea class="form-control" rows="5" name="message"
					lay-reqText="Please enter message content" lay-verify="required" placeholder="Please enter message content"></textarea>
			</div>
			...
			<div class="form-group text-center pt-10 pb-10">
					<p><button class="layui-btn f-20  layui-btn-fluid" lay-submit="" lay-filter="formDemo">Submit now</button></p>
					<br/>
			</div>
		</form>
	</div>
