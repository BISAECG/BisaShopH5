    ...
    <div class="content">
        <div class="container-full">
            <div class="row" style="margin: 0;">
                <img class="img-responsive center-block" src="/resources/img/index/offer.png" alt="碧沙康健心电仪限时活动">
            </div>
            <div class="row" style="margin: 0;">
                <div class="col-xs-12">
                    <p class="title-p text-center">All products</p>
                    <div class="line">
                        <p class="line-top"></p>
                        <p class="line-btm"></p>
                    </div>
                    ...
                    <div class="row">
                        <div class=" col-xs-10 col-xs-offset-1" style="padding: 0;">
                            ...
                            <div class="product_price mt-15">
                                <span>￥1280</span>
                                <span>￥1800</span>
                                <a class="pull-right" href="details.html">More</a>
                            </div>
                        </div>
                    </div>
                </div>
