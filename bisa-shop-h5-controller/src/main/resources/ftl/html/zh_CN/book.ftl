    ...
    <form class="layui-form" id="messageForm" action="">
        <div class="row messageThere">
            <div class="form-group col-md-3" style="">
                ...
                <input type="text" class="form-control" required lay-verify="required" name="name" id="name" lay-reqText="请输入姓名"
                       placeholder="请输入姓名">
            </div>
            <div class="form-group col-md-3">
                <label for="phone" class="control-label">电话:</label>
                <input type="text" class="form-control" required lay-verify="required" name="phone" id="phone" lay-reqText="请输入电话"
                       placeholder="请输入电话">
            </div>
            <div class="form-group col-md-3">
                <label for="email" class="control-label">邮箱:</label>
                <input type="email" class="form-control" required lay-verify="required|email" name="mail" id="mail" lay-reqText="请输入邮箱"
                       placeholder="请输入邮箱">
            </div>
            <div class="form-group col-md-3">
        ...
        <div class="form-group text-center pt-10 pb-10">
            <p>
                <button class="layui-btn f-20  layui-btn-fluid" lay-submit="" lay-filter="formDemo">立即提交</button>
            </p>
            <br/>
        </div>
    </form>
