    ...
    <div class="row head">
        ...
        <div class="col-xs-3 col-xs-offset-1 col-sm-2 col-sm-offset-2 text-center" style="padding-left: 0px;padding-right: 10px;">
            <select id="lang" class="form-control">
                <option value="/index?lang=zh_CN" selected="selected">简体</option>
                <option value="/index?lang=zh_HK">繁体</option>
        ...
        <div class="list">
            <ul id="nav"  style="pandding-top: 20px;" >
           		   <#list empList as item>
           				<li><a href='${item.name}.html'>${item.column_name_CN} <i class="fa fa-angle-right " aria-hidden="true"></i></a></li> 
						 <#if (item_index == 0)>
						 	 <li> <a href="news.html">新闻<i class="fa fa-angle-right " aria-hidden="true"></i> </a></li>   
...
<div class="fixedRight">
    <ul>
        <li>
            <a href="instructions.html">使用视屏</a>
        </li>
        <li>
...
$(document).ready(function() {
    ...
    $.ajax({
        ...
        success: function (data) {
        	if(data.code=="0"){
        		$("#nav").append("<li><a href='#'>個人中心<i class='fa fa-angle-right' aria-hidden='true'></i></a></li>");
