		...
		<div class="row contactInfo">
			...
			<div class="col-md-7 boardLeft">
				<div class="col-md-10">
					...
					<p>
						<span>銷售咨詢(中國):</span> <span>(86) 0755-2688 0962</span>

					</p>
					<p class="mb-20">
						<span>銷售咨詢(香港):</span> <span>(852) 24230600</span>
					</p>
					<p class="mb-20">
						<span>傳真:</span> <span>(852) 2423 0148</span>
					</p>
					<p class="mb-30">
						<span>直接致電銷售人員,立即進行購買咨詢,</span> <span>工作日</span> <span
		...
		<form class="layui-form" id="messageForm" action="">
			<div class="row messageThere">
				<div class="form-group col-md-3" style="">
					<label for="name" class="control-label">姓名:</label> <input
						...
						name="name" id="name" lay-reqText="請輸入姓名" placeholder="請輸入姓名">
				</div>
				<div class="form-group col-md-3">
					<label for="phone" class="control-label">電話:</label> <input
						type="text" class="form-control" required lay-verify="required"
						name="phone" id="phone" lay-reqText="請輸入電話" placeholder="請輸入電話">
				</div>
				<div class="form-group col-md-3">
					<label for="email" class="control-label">郵箱:</label> <input
						type="email" class="form-control" required
						lay-verify="required|email" name="mail" id="mail"
						lay-reqText="請輸入郵箱" placeholder="請輸入郵箱">
				</div>
				<div class="form-group col-md-3">
					<label for="message_type" class="control-label">類別:</label> <select
						class="form-control" name="message_type" lay-reqText="請輸入類別"
			...
			<div class="form-group messageFour">
				...
				<textarea class="form-control" rows="5" name="message"
					lay-reqText="請輸入留言" lay-verify="required" placeholder="請輸入留言"></textarea>
			</div>
			  ...
			  <img alt="" id="imgCode" src="/common/kaptcha">
				<div class="layui-input-inline" style="width:150px;">
					<input type="code" id="code" name="code" required
						lay-verify="required" lay-reqText="請輸入驗證碼" placeholder="請輸入驗證碼"
