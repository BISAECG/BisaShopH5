        ...
        <div class="col-xs-12">
            <ul>
                <#list empList as item>
           				<li><a href='${item.name}.html'>${item.column_name_HK} <i class="fa fa-chevron-right pull-right" ></i></a></li> 
						 <#if (item_index == 0)>
						 	<li> <a href="news.html">新聞<i class="fa fa-chevron-right pull-right" ></i> </a></li>   
		                    <li> <a href="qa.html">健康問答<i class="fa fa-chevron-right pull-right"></i> </a></li>   
						 </#if>
				 </#list>
            </ul>
        </div>
