...
public class WebException extends RuntimeException {
    ...
    private String code;
    public WebException(String messageCode) {
        super(getCodeMessage(messageCode));
        this.code = messageCode;
    }
    public WebException(String messageCode,Object... args) {
        super(getCodeMessage(messageCode));
        this.code = messageCode;
    }
    private static String getCodeMessage(String messageCode) {
        ...
        try {
            Class appErrorCode = classLoader.loadClass("com.bisa.health.shop.entity.WebException");
